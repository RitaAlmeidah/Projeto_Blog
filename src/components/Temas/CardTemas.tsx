...
function CardTemas({tema}: CardTemaProps) {
  return (
    <div className="grid h-screen place-items-center font-bold bg-gradient-to-r from-indigo-500 to-purple-500 via-cyan-500 to-blue-500">
      <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
        <header className='py-2 px-6 text-white font-bold text-2xl'>Tema</header>
        <p className='p-8 text-3xl text-indigo-900 bg-slate-200 h-full'>{tema.descricao}</p>
        <div className="flex">
          ...
          <Link to={`/deletarTema/${tema.id}`} className='text-white bg-orange-600 hover:bg-orange-400 w-full flex items-center justify-center'>
